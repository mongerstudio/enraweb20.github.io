...
if(filter_input(INPUT_POST, 'add_to_cart'))
 ...
 if(filter_input(INPUT_GET, 'action')=='delete')
 {
	 foreach($_SESSION['shopping_cart'] as $key => $product)
	 {
		 ...
		 {//remove product from shopping cart when it matches with product id
...
<html>
   <head>
      <title>Enrapower Shopping Cart</title>
	        ...
	        if(mysqli_num_rows($result)>0):
				...
				<div class="col-sm-4 col-md-3">
				   <form method="post" action="cart.php?action=add&id=<?php echo $product['id']; ?>">
				     <div class="tbl_product2">
					    <img src="<?php echo $product['image'];?>" class="img-responsive"/>
						<h4 class="text-info"><?php echo $product['name'];?></h4>
						<h4>$ <?php echo $product['price'];?></h4>
						<h4 class="text-info"><?php echo $product['Availability'];?></h4>
	   ...
	   <table class="table">
		...
		<tr>
		   ...
		   <td colspan="5">
			 ...
			 <a href="sales@enrapower.com" class="button">Checkout</a>
			 <?php endif;endif; ?>
